...
INVENTORY_COLOR = pygame.Color(140, 140, 140)  # цвета ячеек
...
INFO_COLOR = pygame.Color(110, 110, 110)  # цвета
PANEL_COLOR = pygame.Color(130, 130, 130)
CLOSE_PANEL_COLOR = pygame.Color(130, 130, 130)
DESCR_COLOR = pygame.Color(130, 130, 130)
BUY_COLOR1 = pygame.Color(160, 160, 160)
BUY_COLOR2 = pygame.Color(110, 110, 110)
BUY_COLOR3 = pygame.Color(110, 100, 100)
BUY_COLOR4 = pygame.Color(130, 130, 130)
...
class Information():
    def __init__(self, item_name, money_score, info, free_slots=None):
        ...
        self.buttons = [Button('-', TEXT_COLOR, CLOSE_BUTTON, FONT,
                               SIZE[0] - PAD11 - CLOSE_BUTTON,
                               PAD11 - CLOSE_BUTTON,
                               CLOSE_BUTTON, CLOSE_BUTTON,
                               (CLOSE_COLOR1, CLOSE_COLOR2, CLOSE_COLOR3)),
