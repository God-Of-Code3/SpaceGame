...
FONT = None # Шрифт
FILES_WAY = 'C:\\Users\\Антон\\Desktop\\Яндекс\\Inventory\\data\\' # Путь для файлов
HIGH_FILES_WAY = 'C:\\Users\\Антон\\Desktop\\Яндекс\\Inventory\\data\\high-quality-textures\\' # Путь для файлов в высоком разрешении
...
SETTINGS_SIZE = (500, 100)
# Отступы настроек
PAD15 = 30 # верхняя панель
PAD16 = 10 # кнопок от окна
PAD17 = 20 # размер кнопок
